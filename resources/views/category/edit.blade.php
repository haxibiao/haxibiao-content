        ...
        <div class="col-sm-10 main">
            ...
            <table class="form-menu">
                <tbody>
                    <tr>
                        <td>
                            <div class="avatar-category"><img src="{{ $category->logo_url }}" alt="" id="previewImage">
                            </div>
                        </td>
                        <td>
                    ...
                    <tr style="display: none;" id="upload_app_logo">
                        <td>
                            <div class="avatar-category"><img src="{{ $category->logo_app }}" alt="" id="preview_app_ogo">
                            </div>
                        </td>
                        <td>
                            <a rel="noreferrer" class="btn-base btn-hollow btn-md btn-file">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="input-style" name="name" placeholder="填写名称，不超过50字"
                                value="{{ $category->name }}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="input-style" name="name_en" minlength="5"
                                placeholder="填写英文名称(5字母以上)，建议用中文全拼，英语单词建议用-隔开" value="{{ $category->name_en }}">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="add-manager">
                        ...
                        <td>
                            <category-select categories="{{ json_encode($categories->pluck('name', 'id')) }}">
                            </category-select>
                        </td>
                    </tr>
                    @if ($parent_category = $category->parent)
                        <tr class="add-manager">
                            ...
                            <td>
                                <a class="btn btn-default" href="/category/{{ $parent_category->id }}"
                                    role="button">{{ $parent_category->name }}</a>
                            </td>
                        </tr>
                    @endif
                    <tr>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <input type="radio" name="status"
                                        {{ $category->status == 1 ? 'checked="checked"' : '' }} value="1"><span>允许</span>
                                </div>
                                <div class="col-xs-18">
                                    <input type="radio" name="status"
                                        {{ $category->status == 0 ? 'checked="checked"' : '' }}
                                        value="0"><span>不允许</span>
                                </div>
                            </div>
                        </td>
                    </tr>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <input type="radio" name="request_status"
                                        {{ $category->request_status == 1 ? 'checked="checked"' : '' }} checked="checked"
                                        value="1" {{ $category->status == 0 ? 'disabled' : '' }}> <span>需要</span>
                                </div>
                                <div class="col-xs-18">
                                    <input type="radio" name="request_status"
                                        {{ $category->request_status == 0 ? 'checked="checked"' : '' }} value="0"
                                        {{ $category->status == 0 ? 'disabled' : '' }}> <span>不需要</span>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-xs-6">
                                    <input type="radio" name="is_official"
                                        {{ $category->is_official == 1 ? 'checked="checked"' : '' }} value="1">
                                    <span>是</span>
                                </div>
                                <div class="col-xs-18">
                                    <input type="radio" name="is_official"
                                        {{ $category->is_official == 0 ? 'checked="checked"' : '' }} value="0">
                                    <span>否</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr class="disabled">
                        ...
                        <td>
                            <div class="row">
                                <div class="col-xs-6">
                                    <input type="radio" name="is_for_app"
                                        {{ $category->is_for_app == 1 ? 'checked="checked"' : '' }} value="1" disabled>
                                    <span>是</span>
                                </div>
                                <div class="col-xs-18">
                                    <input type="radio" name="is_for_app"
                                        {{ $category->is_for_app == 0 ? 'checked="checked"' : '' }} value="0" disabled>
                                    <span>否</span>
                                </div>
                            </div>
                        </td>
    ...
    <script>
        ...
        $(function() {
            ...
            $('[name="status"]').on('change', function() {
                if ($(this).val() > 0) {
                    $('[name="request_status"]').prop('disabled', false).parents('tr').removeClass(
                        'disabled');
                } else {
                    $('[name="request_status"]').prop('disabled', 'disabled').parents('tr').addClass(
                        'disabled');
                }
            });
