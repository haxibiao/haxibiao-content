            ...
            <table class="form-menu">
                <tbody>
                    ...
                    <tr style="display: none;" id="upload_app_logo">
                        <td>
                            <div class="avatar-category"><img src="/images/new-category.png" alt="" id="preview_app_ogo">
                            </div>
                        </td>
                        <td>
                            <a rel="noreferrer" class="btn-base btn-hollow btn-md btn-file">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input-style" type="text" name="name_en" minlength="5"
                                placeholder="填写英文名称(5字母以上)，建议用中文全拼，英语单词建议用-隔开">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-xs-6">
                                    <input type="radio" name="status" checked="checked" value="1"><span>允许</span>
                                </div>
                                <div class="col-xs-18">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-xs-6">
                                    <input type="radio" name="request_status" checked="checked" value="1"> <span>需要</span>
                                </div>
                                <div class="col-xs-18">
                    ...
                    <tr class="disabled">
                        ...
                        <td>
                            <div class="row">
                                ...
                                <div class="col-xs-18">
                                    <input type="radio" name="is_for_app" checked="checked" value="0" disabled>
                                    <span>否</span>
                                </div>
                            </div>
                        </td>
        ...
        $(function() {
            ...
            $('[name="is_official"]').on('change', function() {
                if ($(this).val() > 0) {
                    ...
                    $('[name="is_for_app"]').prop('disabled', 'disabled').parents('tr').addClass(
                    'disabled');
