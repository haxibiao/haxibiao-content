		...
		<div class="clearfix">
			...
			<div class="aside sm-right hidden-xs">
				...
				<div class="administrator">
					...
					<ul>
						<li><a href="/user/{{ $collection->user->id }}" class="avatar"><img src="{{ $collection->user->avatarUrl }}" alt=""></a><a href="/user/{{ $collection->user->id }}" class="name">{{ $collection->user->name }}</a></li>
					</ul>
				</div>
			</div>
		</div>
