...
@section('title') 搜索用户 {{ get_kw() }} @endsection
                    ...
                    <div class="user-list follow-user-list">
                        @foreach ($data['users'] as $user)
                            <li class="user-info info-md">
                                ...
                                <follow type="users" id="{{ $user->id }}" user-id="{{ user_id() }}"
                                ...
                                <div class="info">
                                    <div class="meta hidden-xs">
                                        <span>关注 {{ $user->followingUsers()->count() }}</span><span>粉丝
                                            {{ $user->count_follows }}</span><span>作品
                                            {{ $user->count_articles }}</span>
                                    </div>
                                    <div class="meta">
