...
@section('title'){{ $question->title }} - 问答 - @stop
            ...
            <div class="main sm-left">
                ...
                <div class="inquisitorial">
                    <div class="author">
                        ...
                        @if ($question->isPay())
                            <span class="amount pull-right">赏金<i
                                    class="iconfont icon-jinqian1"></i>{{ $question->bonus }}元</span>
                        @endif
                    </div>
                </div>
                ...
                @if (Auth::check() && !$question->closed)
                    <answer-tool question-id="{{ $question->id }}" is-self="{{ $question->isSelf() }}"
                    ...
                    <div class="answer-write">
                        <editor name="answer" 　placeholder="{{ $question->isSelf() ? '请补充您的问答信息' : '请开始您的回答' }}"></editor>
                        <div class="submitbar">
